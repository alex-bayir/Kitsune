...
public class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    public FastScroller setPadding(int left, int top, int right, int bottom){
        padding.left=left;
        padding.top=top;
        padding.right=right;
    ...
    public FastScroller setPadding(Rect padding){
        if(padding!=null){
    ...
    private void drawVerticalScrollbar(Canvas canvas) {
        ...
        int left = viewWidth - mVerticalThumbWidth - padding.left;
        ...
        if (isLayoutRTL()) {
            canvas.translate(padding.right, 0);
    ...
    private void drawHorizontalScrollbar(Canvas canvas) {
        ...
        int top = viewHeight - mHorizontalThumbHeight - padding.top;
