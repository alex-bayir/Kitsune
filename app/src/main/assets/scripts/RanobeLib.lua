...
Tags={["Авантюристы"]="328",["Антигерой"]="176",["Бессмертные"]="333",["Боги"]="218",["Борьба за власть"]="309",["Брат и сестра"]="360",["Ведьма"]="339",["Видеоигры"]="204",["Виртуальная реальность"]="214",["Владыка демонов"]="349",["Военные"]="198",["Воспоминания из другого мира"]="310",["Выживание"]="212",["ГГ женщина"]="294",["ГГ имба"]="292",["ГГ мужчина"]="295",["ГГ не ояш"]="325",["ГГ не человек"]="331",["ГГ ояш"]="326",["Главный герой бог"]="324",["Глупый ГГ"]="298",["Горничные"]="171",["Гуро"]="306",["Гяру"]="197",["Демоны"]="157",["Драконы"]="313",["Древний мир"]="317",["Зверолюди"]="163",["Зомби"]="155",["Исторические фигуры"]="323",["Кулинария"]="158",["Культивация"]="161",["ЛГБТ"]="344",["ЛитРПГ"]="319",["Лоли"]="206",["Магия"]="170",["Машинный перевод"]="345",["Медицина"]="159",["Межгалактическая война"]="330",["Монстр Девушки"]="207",["Монстры"]="208",["Мрачный мир"]="316",["Музыка"]="358",["Музыка"]="209",["Ниндзя"]="199",["Обратный Гарем"]="210",["Офисные Работники"]="200",["Пираты"]="341",["Подземелья"]="314",["Политика"]="311",["Полиция"]="201",["Преступники \\ Криминал"]="205",["Призраки \\ Духи"]="196",["Призыватели"]="329",["Прыжки между мирами"]="321",["Путешествие в другой мир"]="318",["Путешествие во времени"]="213",["Рабы"]="355",["Ранги силы"]="312",["Реинкарнация"]="154",["Самураи"]="202",["Скрытие личности"]="315",["Средневековье"]="174",["Традиционные игры"]="203",["Умный ГГ"]="303",["Характерный рост"]="332",["Хикикомори"]="167",["Эволюция"]="322",["Элементы РПГ"]="327",["Эльфы"]="217",["Якудза"]="165"}
...
Types={["Япония"]="10",["Корея"]="11",["Китай"]="12",["Английский"]="13",["Авторский"]="14",["Фанфик"]="15"}
...
function similar(elements)
    ...
    for i=0,(elements and elements:size() or 0)-1,1 do
        ...
        if(utils:text(e and e:selectFirst("span"))=="Манга") then
            url=url:gsub(domain,"mangalib.me")
        end
        similar[n]=e and {
            ["url"]=url,
            ["url_web"]=url,
