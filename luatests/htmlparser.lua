...
function Set:tolist()
	...
	return setmetatable(res,Set.mt)
end

function Set:attr(i,k) return self[i] and self[i]:attr(k) end
...
function ElementNode:attr(k) return self.attributes[k] end
function text(self) return self and self:textonly() end
